...
GRAPH_EXPANSIONS: dict[str, GraphExpansion] = {
    ...
    "workloads/deployments": GraphExpansion(("ReplicaSet", "Pod") + WORKLOAD_RELATED_KINDS + RBAC_RELATED_KINDS),
    "workloads/statefulsets": GraphExpansion(("Pod",) + WORKLOAD_RELATED_KINDS + RBAC_RELATED_KINDS),
